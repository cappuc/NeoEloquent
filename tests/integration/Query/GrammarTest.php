...
class GrammarTest extends TestCase
{
    ...
    public function testPreparingLabel()
    {
        ...
        $this->assertEquals(':`User`:`Artist`:`Official`', $this->grammar->prepareLabels([
            'User',
            'Artist',
            'Official'
        ]), 'order');
        $this->assertEquals(':`Photo`:`Media`', $this->grammar->prepareLabels([
            ':Photo',
            'Media'
        ]), 'intelligent with :');
        $this->assertEquals(':`Photo`:`Media`', $this->grammar->prepareLabels([
    ...
    public function testValufying()
    {
        ...
        $this->assertEquals('\'valu\\\1\', \'valu\\\'2\\\'\', \'val/u3\'', $this->grammar->valufy([
            'valu\1',
            "valu'2'",
            'val/u3'
        ]));
