...
class CypherGrammar extends Grammar
{
     ...
     * @return string
     */
    protected function concatenateWhereClauses($query, $cypher)
    {
        return 'WHERE ' . $this->removeLeadingBoolean(implode(' ', $cypher));
    }
     ...
     * @param string $operation type of operation 'add' or 'drop'
     * @return string
     */
